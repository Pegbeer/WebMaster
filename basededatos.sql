...
/****** Object:  Database [WebMasterDB]    Script Date: 27/6/2020 1:37:33 a. m. ******/
CREATE DATABASE [WebMasterDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'WebMasterDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\WebMasterDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'WebMasterDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\WebMasterDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [WebMasterDB] SET COMPATIBILITY_LEVEL = 140
GO
...
ALTER DATABASE [WebMasterDB] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [WebMasterDB] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [WebMasterDB] SET READ_COMMITTED_SNAPSHOT OFF 
GO
...
ALTER DATABASE [WebMasterDB] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [WebMasterDB] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [WebMasterDB] SET QUERY_STORE = OFF
GO
